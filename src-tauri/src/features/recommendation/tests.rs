#[cfg(test)]
mod tests {
    use crate::features::recommendation::{model::{Article, ArticleCategory}, service::calculate_relevance_score};
    ...
    fn test_scoring_system() {
        ...
        assert!(s1 > s3, "Rust specific should score higher than general code");
        assert!(s3 > s2, "General code should score higher than stock market noise");
