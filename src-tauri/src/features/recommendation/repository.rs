...
pub trait RecommendationRepository {
    fn get_all_articles(&self) -> Result<Vec<Article>, String>;
    fn get_all_feedback(&self) -> Result<Vec<Feedback>, String>;
    ...
    fn get_existing_tags(&self, url: &str) -> Result<Option<String>, String>;
}
